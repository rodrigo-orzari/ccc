...
## Corpus Check
- 116 files · ~91,595 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 231 nodes · 301 edges · 23 communities (16 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7b2e6789`
...
## Knowledge Gaps
- **88 isolated node(s):** `PipelineStatus`, `ProviderStatus`, `StatusData`, `PROVIDER_COLORS`, `PROVIDER_URLS` (+83 more)
