...
## Corpus Check
- 116 files · ~91,209 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 215 nodes · 283 edges · 19 communities (13 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4eabbbc5`
...
## Knowledge Gaps
- **84 isolated node(s):** `ChartsViewProps`, `FilterSectionProps`, `FilterSidebarProps`, `PROVIDERS`, `ColDef` (+79 more)
...
- **What connects `ChartsViewProps`, `FilterSectionProps`, `FilterSidebarProps` to the rest of the system?**
