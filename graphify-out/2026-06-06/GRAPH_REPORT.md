...
## Corpus Check
- 116 files · ~91,250 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 222 nodes · 289 edges · 21 communities (15 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `13c901b7`
...
## Knowledge Gaps
- **87 isolated node(s):** `PIPELINE_DISPLAY`, `PipelineStatus`, `ProviderStatus`, `StatusData`, `PROVIDER_COLORS` (+82 more)
...
- **What connects `PIPELINE_DISPLAY`, `PipelineStatus`, `ProviderStatus` to the rest of the system?**
