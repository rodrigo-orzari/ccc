...
## Corpus Check
- 61 files · ~76,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 485 nodes · 663 edges · 39 communities (26 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df2c0be6`
...
Cohesion: 0.13
Nodes (11): baseDigitaloceanEntries, DIGITALOCEAN_FUNCTIONS_LANGUAGES, DIGITALOCEAN_SERVERLESS, baseGcpEntries, GCP_CLOUD_RUN_LANGUAGES, GCP_SERVERLESS, baseOracleEntries, ORACLE_LAMBDA_LANGUAGES (+3 more)

### Community 1 - "Container Provider Configs"
Cohesion: 0.15
Nodes (6): AWS_CONTAINERS, baseAwsContainerEntries, baseDigitaloceanContainerEntries, DIGITALOCEAN_CONTAINERS, baseGcpContainerEntries, GCP_CONTAINERS
...
Cohesion: 0.07
Nodes (14): AWSContainersStaticAdapter, AzureContainersStaticAdapter, DigitalOceanContainersStaticAdapter, AWSAdapter, AzureAdapter, BaseAdapter, DigitalOceanAdapter, GCPAdapter (+6 more)
...
Cohesion: 0.11
Nodes (11): parseDbUrl(), run(), AWSContainersLiveAdapter, AzureContainersLiveAdapter, DigitalOceanContainersLiveAdapter, GCPContainersLiveAdapter, OracleContainersLiveAdapter, GCPContainersStaticAdapter (+3 more)
...
Cohesion: 0.21
Nodes (8): DIGITALOCEAN_INSTANCES, DigitalOceanInstanceConfig, GCP_INSTANCES, GcpInstanceConfig, ORACLE_INSTANCES, OracleInstanceConfig, STATIC_NETWORKING_PRICING, PriceDriftResult
...
Cohesion: 0.31
Nodes (4): DatabasePricingPipeline, main(), parseDbUrl(), PricingPipeline
...
## Knowledge Gaps
- **190 isolated node(s):** `pool`, `baseDigitaloceanContainerEntries`, `baseOracleContainerEntries`, `baseAwsContainerEntries`, `baseAzureContainerEntries` (+185 more)
...
- **Why does `BaseAdapter` connect `Cloud Instance Configs` to `Serverless Provider Configs`, `Container Provider Configs`, `Database Instance Configs`, `Community 11`, `Community 12`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `PricingRecord` connect `Community 12` to `Serverless Provider Configs`, `Container Provider Configs`, `Database Instance Configs`, `Cloud Instance Configs`, `Community 11`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **What connects `pool`, `baseDigitaloceanContainerEntries`, `baseOracleContainerEntries` to the rest of the system?**
