...
## Corpus Check
- 80 files · ~81,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 547 nodes · 749 edges · 42 communities (27 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `748f2e6e`
...
9. `scripts` - 9 edges
10. `Serverless Language Filter` - 9 edges
...
Cohesion: 0.05
Nodes (17): AWS_CONTAINERS, baseAwsContainerEntries, AZURE_CONTAINERS, baseAzureContainerEntries, baseDigitaloceanContainerEntries, DIGITALOCEAN_CONTAINERS, baseGcpContainerEntries, GCP_CONTAINERS (+9 more)
...
Cohesion: 0.05
Nodes (29): CloudSqlInstanceConfig, DIGITALOCEAN_DB_INSTANCES, DigitalOceanDbInstanceConfig, GCP_CLOUD_SQL_INSTANCES, ORACLE_AUTONOMOUS_INSTANCES, ORACLE_MYSQL_HEATWAVE_INSTANCES, ORACLE_POSTGRESQL_INSTANCES, OracleAutonomousConfig (+21 more)

### Community 3 - "Pricing Pipeline Architecture"
Cohesion: 0.06
Nodes (41): AWSAdapter, AzureAdapter, Batch Insert, buildPricingFilters, Cron Job (Sunday Midnight), Data Staleness Warning System, DigitalOceanAdapter, DigitalOcean App Platform (+33 more)
...
Cohesion: 0.05
Nodes (24): AWS_LAMBDA_LANGUAGES, AWS_SERVERLESS, baseAwsEntries, AZURE_FUNCTIONS_LANGUAGES, AZURE_SERVERLESS, baseAzureEntries, baseDigitaloceanEntries, DIGITALOCEAN_FUNCTIONS_LANGUAGES (+16 more)
...
Cohesion: 0.07
Nodes (22): DIGITALOCEAN_INSTANCES, DigitalOceanInstanceConfig, GCP_INSTANCES, GcpInstanceConfig, ORACLE_INSTANCES, OracleInstanceConfig, sql, startServer() (+14 more)
...
- **Why does `BaseAdapter` connect `Database Instance Configs` to `Serverless Provider Configs`, `Community 32`, `Community 35`, `Cloud Instance Configs`, `Community 31`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `PricingRecord` connect `Community 35` to `Serverless Provider Configs`, `Community 32`, `Database Instance Configs`, `Cloud Instance Configs`, `Community 31`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `PricingPipeline` connect `Community 32` to `Serverless Provider Configs`, `Database Instance Configs`, `Community 35`, `Cloud Instance Configs`, `Community 31`?**
