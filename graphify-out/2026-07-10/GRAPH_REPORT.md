...
## Corpus Check
- 153 files · ~181,482 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 881 nodes · 1410 edges · 62 communities (43 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `52c82c52`
...
Cohesion: 0.06
Nodes (22): VECTOR_DATABASES, ALIBABA_REDIS_INSTANCES, AlibabaDBAdapter, AWS_DOCUMENTDB_INSTANCES, AWS_DYNAMODB_INSTANCES, AWS_ELASTICACHE_INSTANCES, AWSDynamoDBAdapter, AWSElastiCacheAdapter (+14 more)
...
Cohesion: 0.10
Nodes (10): AWSContainersLiveAdapter, DigitalOceanContainersLiveAdapter, AWSAdapter, BaseAdapter, AlibabaServerlessAdapter, AWSServerlessAdapter, AWSServerlessLiveAdapter, DigitalOceanServerlessAdapter (+2 more)
...
Cohesion: 0.22
Nodes (5): DatabasePricingPipeline, PricingPipeline, getOracleStorageRows(), mapStaticRows(), StoragePricingPipeline

### Community 34 - "Community 34"
Cohesion: 0.29
Nodes (8): fetchOracleCatalog(), findPrice(), nameIncludes(), OracleProduct, findOracleGpuRate(), ORACLE_FLEX_FAMILIES, ORACLE_GPU_MODELS, OracleAdapter
...
Cohesion: 0.20
Nodes (4): AwsFargateScraper, AzureContainerInstancesScraper, OracleContainersLiveAdapter, findOracleFlexRates()
...
Cohesion: 0.05
Nodes (29): ALIBABA_FC_LANGUAGES, ALIBABA_SERVERLESS, baseAlibabaEntries, AWS_LAMBDA_LANGUAGES, AWS_SERVERLESS, baseAwsEntries, AZURE_FUNCTIONS_LANGUAGES, AZURE_SERVERLESS (+21 more)

### Community 50 - "Community 50"
Cohesion: 0.22
Nodes (3): WORKLOADS, integrationMonthlyCost(), POST()
...
- **Why does `PricingRecord` connect `Community 36` to `Database Instance Configs`, `Community 35`, `Community 34`, `Community 37`, `Community 38`, `Community 69`, `Community 6`, `Community 9`, `Community 47`, `Community 18`, `Community 53`, `Community 56`, `Community 28`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `BaseAdapter` connect `Community 28` to `Database Instance Configs`, `Community 35`, `Community 36`, `Community 69`, `Community 37`, `Community 34`, `Community 9`, `Community 42`, `Community 47`, `Community 18`, `Community 19`, `Community 53`, `Community 56`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `PROVIDERS` connect `Community 7` to `Community 8`, `Community 34`?**
