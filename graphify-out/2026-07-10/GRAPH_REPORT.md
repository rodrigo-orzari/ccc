...
## Corpus Check
- 153 files · ~181,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 883 nodes · 1414 edges · 72 communities (49 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc888c18`
...
Cohesion: 0.20
Nodes (7): DatabricksAzureAdapter, SynapseAzureAdapter, AlibabaAdapter, AzureAdapter, fetchAlibabaEcsLiveRecords(), fetchWithRetry(), sleep()
...
Cohesion: 0.07
Nodes (20): VECTOR_DATABASES, ALIBABA_REDIS_INSTANCES, AlibabaDBAdapter, AWS_DOCUMENTDB_INSTANCES, AWS_DYNAMODB_INSTANCES, AWS_ELASTICACHE_INSTANCES, AWSDynamoDBAdapter, AWSElastiCacheAdapter (+12 more)
...
Cohesion: 0.12
Nodes (22): DB_FAMILY_MAPPINGS, GET(), GET(), POST(), buildPricingFilters(), initDb(), parseFilterList(), requireAdminAuth() (+14 more)
...
Cohesion: 0.11
Nodes (9): AWSContainersLiveAdapter, DigitalOceanContainersLiveAdapter, AlibabaAnalyticsAdapter, GCPCloudSQLAdapter, VectorDatabasesAdapter, AWSAdapter, BaseAdapter, AlibabaServerlessAdapter (+1 more)
...
Cohesion: 0.16
Nodes (9): PIPELINE_REGISTRY, PipelineCtor, AppHostingPricingPipeline, DataAnalyticsPricingPipeline, DatabasePricingPipeline, PricingPipeline, SecurityPricingPipeline, mapStaticRows() (+1 more)
...
Cohesion: 0.35
Nodes (3): AzureContainersLiveAdapter, PricingRecord, ServerlessPricingPipeline
...
Cohesion: 0.13
Nodes (8): baseGcpEntries, GCP_CLOUD_RUN_LANGUAGES, GCP_SERVERLESS, AWSServerlessAdapter, AzureServerlessAdapter, DigitalOceanServerlessAdapter, GCPServerlessAdapter, OracleServerlessAdapter
...
Cohesion: 0.60
Nodes (4): AlibabaCredentials, buildSignedUrl(), percentEncode(), randomNonce()
...
Cohesion: 0.24
Nodes (5): NetworkingPricingPipeline, STATIC_NETWORKING_PRICING, ensureProviderId(), PriceDriftResult, STATIC_SECURITY_PRICING
...
Cohesion: 0.11
Nodes (17): GCPContainersLiveAdapter, fetchAllSkus(), findGcpServiceName(), FAMILIES, fetchGcpComputeRates(), findFamilyRate(), findGpuRate(), GcpComputeRates (+9 more)
...
Cohesion: 0.18
Nodes (8): WORKLOADS, SponsorSlot, WorkloadComponent, WorkloadDefinition, PRODUCT_TYPE_LABELS, PRODUCT_TYPE_ORDER, integrationMonthlyCost(), POST()
...
## Knowledge Gaps
- **303 isolated node(s):** `FAMILIES`, `GcpComputeRates`, `ORACLE_FLEX_FAMILIES`, `ORACLE_GPU_MODELS`, `REGION_OPTIONS` (+298 more)
...
- **Why does `PricingRecord` connect `Community 36` to `Community 34`, `Database Instance Configs`, `Community 35`, `Community 69`, `Community 38`, `Community 39`, `Community 6`, `Community 9`, `Community 47`, `Community 18`, `Community 53`, `Community 56`, `Community 59`, `Community 28`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `BaseAdapter` connect `Community 28` to `Community 34`, `Database Instance Configs`, `Community 36`, `Community 69`, `Community 35`, `Community 39`, `Community 9`, `Community 18`, `Community 19`, `Community 53`, `Community 56`, `Community 59`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `PROVIDERS` connect `Community 7` to `Community 8`, `Community 34`, `Community 11`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **What connects `FAMILIES`, `GcpComputeRates`, `ORACLE_FLEX_FAMILIES` to the rest of the system?**
