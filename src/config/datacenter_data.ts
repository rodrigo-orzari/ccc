...
export const PROVIDER_INFRA: ProviderInfrastructure[] = [
  ...
  },
  {
    ...
    regionList: [
      { name: 'US East (New Jersey)', code: 'nj', geography: 'N. America', azCount: 0, launched: 2014, status: 'available' },
      { name: 'US East (Virginia)', code: 'va', geography: 'N. America', azCount: 0, launched: 2014, status: 'available' },
      { name: 'US Central (Chicago)', code: 'il', geography: 'N. America', azCount: 0, launched: 2014, status: 'available' },
      { name: 'US West (Los Angeles)', code: 'lax', geography: 'N. America', azCount: 0, launched: 2016, status: 'available' },
      { name: 'Canada (Toronto)', code: 'tor', geography: 'N. America', azCount: 0, launched: 2015, status: 'available' },
      { name: 'Europe (London)', code: 'lhr', geography: 'W. Europe', azCount: 0, launched: 2014, status: 'available' },
      { name: 'Europe (Frankfurt)', code: 'fra', geography: 'W. Europe', azCount: 0, launched: 2014, status: 'available' },
      { name: 'Europe (Amsterdam)', code: 'ams', geography: 'W. Europe', azCount: 0, launched: 2014, status: 'available' },
      { name: 'Europe (Paris)', code: 'par', geography: 'W. Europe', azCount: 0, launched: 2015, status: 'available' },
      { name: 'Japan (Tokyo)', code: 'nrt', geography: 'Asia Pacific', azCount: 0, launched: 2014, status: 'available' },
      { name: 'Singapore', code: 'sgp', geography: 'Asia Pacific', azCount: 0, launched: 2015, status: 'available' },
      { name: 'Australia (Sydney)', code: 'syd', geography: 'Australia', azCount: 0, launched: 2016, status: 'available' },
      { name: 'India (Delhi)', code: 'del', geography: 'Asia Pacific', azCount: 0, launched: 2021, status: 'available' },
      { name: 'Brazil (São Paulo)', code: 'sao', geography: 'S. America', azCount: 0, launched: 2017, status: 'available' },
      { name: 'UAE (Dubai)', code: 'uae', geography: 'Mid East & Africa', azCount: 0, launched: 2022, status: 'available' },
    ],
    sources: [
      { label: 'Vultr Global Infrastructure', url: 'https://www.vultr.com/locations/' },
    ],
    lastVerified: '2026-06-17',
  },
  {
    ...
    regionList: [
      { name: 'Germany (Falkenstein)', code: 'fsn1', geography: 'W. Europe', azCount: 0, launched: 2015, status: 'available' },
      { name: 'Germany (Nuremberg)', code: 'nbg1', geography: 'W. Europe', azCount: 0, launched: 2015, status: 'available' },
      { name: 'Finland (Helsinki)', code: 'hel1', geography: 'W. Europe', azCount: 0, launched: 2019, status: 'available' },
      { name: 'United States (Ashburn)', code: 'ash', geography: 'N. America', azCount: 0, launched: 2022, status: 'available' },
      { name: 'India (Mumbai)', code: 'ind', geography: 'Asia Pacific', azCount: 0, launched: 2023, status: 'announced' },
    ],
    sources: [
      { label: 'Hetzner Cloud Locations', url: 'https://www.hetzner.cloud/locations' },
    ],
    lastVerified: '2026-06-17',
  },
];
