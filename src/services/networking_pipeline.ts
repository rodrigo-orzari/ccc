...
const STATIC_NETWORKING_PRICING = [
  ...
  // ─── VPN Gateways ────────────────────────────────────────────────────────────
  { provider: 'aws',    service: 'VPN Gateway', category: 'Site-to-Site VPN', instance_type: 'VPN Connection (Hourly)',  price_per_unit: 0.05,   unit: 'Hour', geography: 'US East', attributes: { transfer_tier: 'Per Tunnel',   destination: 'On-Premises', included_transfer: 'None',              connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'N/A'    } },
  { provider: 'aws',    service: 'VPN Gateway', category: 'Site-to-Site VPN', instance_type: 'VPN Data Transfer',       price_per_unit: 0.048,  unit: 'GB',   geography: 'US East', attributes: { transfer_tier: 'Flat Rate',   destination: 'On-Premises', included_transfer: 'None',              connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'Egress'  } },
  { provider: 'gcp',    service: 'VPN Gateway', category: 'Cloud VPN',        instance_type: 'VPN Tunnel (Hourly)',     price_per_unit: 0.05,   unit: 'Hour', geography: 'Global',  attributes: { transfer_tier: 'Per Tunnel',   destination: 'On-Premises', included_transfer: 'None',              connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'N/A'    } },
  { provider: 'azure',  service: 'VPN Gateway', category: 'VPN Gateway',      instance_type: 'VpnGw1 (Hourly)',        price_per_unit: 0.19,   unit: 'Hour', geography: 'US East', attributes: { transfer_tier: 'Hourly Base',  destination: 'On-Premises', included_transfer: 'None',              connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'N/A'    } },
  { provider: 'oracle', service: 'VPN Gateway', category: 'VPN Connect',      instance_type: 'IPSec Tunnel (Hourly)',   price_per_unit: 0.0085, unit: 'Hour', geography: 'Global',  attributes: { transfer_tier: 'Per Tunnel',   destination: 'On-Premises', included_transfer: '2 tunnels/mo free', connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'N/A'    } },
  { provider: 'alibaba', service: 'VPN Gateway', category: 'VPN Gateway',     instance_type: 'VPN Gateway (5 Mbps)',   price_per_unit: 0.052,  unit: 'Hour', geography: 'Global',  attributes: { transfer_tier: 'Hourly Base',  destination: 'On-Premises', included_transfer: 'None',              connection_type: 'Point-to-Point', routing_type: 'Dynamic', ha_support: 'Yes', vpc_support: 'Yes', transfer_direction: 'N/A'    } },
];
